    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-gray-900 to-slate-800 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  className="h-4 w-4 bg-gray-800 border-gray-600 rounded text-blue-600 focus:ring-blue-500 focus:ring-2"
                />
        ...
        <div className="mt-6 flex items-center justify-center space-x-2 text-gray-400">
          ...
          <span className="text-sm">Secure login with 256-bit encryption</span>
        </div>
      </div>
    </div>
  );
